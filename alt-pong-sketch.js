...
function bouncePaddle() {
  ...
  if (abs(yBall - paddle2.y) <= paddle2.height/2 && abs(paddle2.x - xBall) < 5) {
  ...
  if (abs(yBall - paddle1.y) <= paddle1.height/2 && abs(paddle1.x - xBall) < 5) {
...
function movePaddles() {
  ...
  // mappedSensor = map(sensor1, 0, 517, screenWidth/13, screenWidth/2 - screenWidth/13);
